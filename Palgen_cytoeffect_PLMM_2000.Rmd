...
```
HMC diagnostics seem good at first glance.
...
```
Rhat is above the recommended 1.1, indicating issues with convergence. 
...
CD66 negatively correlates with many proteins in both post-prime and post-boost. Donor correlations are not clearly apparent which is probably due to the small donor sample size. 
